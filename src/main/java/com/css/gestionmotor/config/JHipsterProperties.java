...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "gestionMotor@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "gestionMotor API";

        private String description = "gestionMotor API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "gestionMotor";
